...
import {
  Search, X, ChevronLeft, ChevronRight, Star, Map as MapIcon,
} from 'lucide-react';
import VenueCard from '../components/venues/VenueCard';
import VenueMapModal from '../components/venues/VenueMapModal';
...
export default function Venues() {
  ...
  return (
    <div className="-mx-4 sm:-mx-6 lg:-mx-8 -my-8 bg-surface">
      <main className="flex h-[calc(100vh-64px)] mt-16 overflow-hidden">
        {/* ============================================================
            LEFT — LIST PANEL (60%)
            ============================================================ */}
        <section className="flex flex-col bg-surface overflow-y-auto no-scrollbar w-full">
          {/* Sticky filters header */}
          <div className="sticky top-0 z-30 bg-surface px-6 pt-8 pb-5 space-y-6">
            {/* Title row + search */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                <motion.button
                  ...
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.96 }}
                  className="shrink-0 flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold text-white bg-gradient-to-r from-primary to-primary-container shadow-ambient"
                >
                  <MapIcon className="h-4 w-4" />
                  <span className="hidden sm:inline">Xaritada ko'rish</span>
                </motion.button>
              </div>
            </div>
