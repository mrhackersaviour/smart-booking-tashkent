...
import { Button, Card, Badge, Avatar, useToast } from '../components/ui';
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-8 py-10 grid grid-cols-12 gap-8">
        ...
        <section className="col-span-12 lg:col-span-7 space-y-6">
          <Card tier="low" padding="lg" className="relative min-h-[500px] flex flex-col">
            ...
            {/* Floor plan viewport — only shown after date & time are selected */}
              ...
              <div>
                ...
                <div className="flex items-center justify-between p-4 bg-surface-container-low rounded-xl">
                  ...
                  <span className="text-primary font-bold whitespace-nowrap">
                    {pricePerGuest.toLocaleString()} UZS
                  </span>
                </div>
              </div>
