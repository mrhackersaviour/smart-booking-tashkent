 ...
 *
 * Two tabs:
 *  1. "Virtual Tour" — 360° panoramic viewer (PanoramicView)
 *  2. "Floor Plan"   — interactive 3D table layout (VenueViewer3D)
 *
 * Both are lazy-loaded so the main bundle stays lean.
 *
 * Follows DESIGN.md:
 *  - Glass overlay (`backdrop-blur-glass`)
                  ...
                  {tab === 'tour' ? (
                    ...
                    >
                      <PanoramicView
                        ...
                        panoramaUrl={venue.panorama_url}
